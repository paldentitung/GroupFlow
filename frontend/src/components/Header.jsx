    ...
    <header className="flex justify-between items-center px-6 py-4 ">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="relative p-2 rounded-lg bg-[#f7f8fa] border border-[#e8eaed] text-[#6b7280] hover:bg-[#eef2ff] hover:text-[#4f46e5] hover:border-[#4f46e5] transition-all duration-150 hover:cursor-pointer"
        >
          <Bell size={17} />
